...
# define ERR_PWD "minishell: pwd: input option is not accepted\n"
# define ERR_UNS "minishell: unset: input option is not accepted\n"
...
int				handle_heredoc_red(t_cmd *cmd, char *op, char *file);
